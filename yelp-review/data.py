...
class YelpPolarityDataset(Dataset):
    """Dataset для Yelp Polarity данных"""
...
class YelpPolarityDataModule(LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        full_train_dataset = YelpPolarityTokenizedDataset(
            train_df, tokenizer=self.tokenizer, max_length=self.max_length
        )
        ...
        self.train_dataset, self.val_dataset = random_split(
            full_train_dataset, [train_size, val_size], generator
        )
        self.test_dataset = YelpPolarityTokenizedDataset(
            test_df, tokenizer=self.tokenizer, max_length=self.max_length
        )
